...
# Stream lit is  easy to used library,
#   Go to documentartion of streamlit and learned some info about stramlit
...
#     connect_to_db,
#     get_basic_info,
#     get_additonal_tables, get_categories, get_suppliers
# )
